      ...
      <main className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <section className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-xl border border-stone-800 bg-stone-900/65 p-5 sm:p-6">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <SignIn />
              <span className="font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-wide text-stone-500">
                free beta • under 60s setup
              </span>
            </div>
          </div>
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[ 
            ...
            <Card key={item.title} className="rounded-xl border-stone-800 bg-stone-900/65">
              <CardHeader className="space-y-2">
                <HugeiconsIcon icon={item.icon} size={20} strokeWidth={1.7} className="text-stone-400" />
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-stone-400 sm:text-base">
                Sign in once and start with snippets, analytics, and contest prep
                already connected.
              </p>
            </div>
