...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#070707] text-zinc-100 overflow-hidden pb-20">
      ...
      <div className="relative z-10 w-full max-w-4xl px-6 py-12 flex flex-col items-center text-center space-y-12">
        
        {/* Header / Logo */}
        <div className="space-y-6">
          <h1 className="font-[family-name:var(--font-geist-pixel-square)] text-4xl md:text-6xl font-bold tracking-tight text-white drop-shadow-sm">
            cfetch
          </h1>
